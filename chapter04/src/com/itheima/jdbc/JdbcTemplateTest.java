...
public class JdbcTemplateTest {
	...
	public void addAccountTest() {
		//加载配置文件
		ApplicationContext applicaitonContext = new ClassPathXmlApplicationContext("applicationContext.xml");
		//获取AccountDao实例
		AccountDao accountDao = (AccountDao) applicaitonContext.getBean("accountDao");
		//创建Account对象，并且向Account对象中添加数据
		Account account = new Account();
		account.setUsername("tom");
		account.setBalance(1000.00);
		//执行addAccount()方法，并且获取返回的结果
