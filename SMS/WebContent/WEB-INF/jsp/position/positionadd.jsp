...
<body>
    ...
    <tr>
      ...
      <input type="text" name="pno" id="pno" /></td>
    </tr>
    <tr>
      <td width="116" height="30" align="right" valign="middle">职位名：</td>
      <td width="378" align="left" valign="middle">
      <input type="text" name="pname" id="pname" /></td>
    </tr>
    <tr>
      <td width="116" height="30" align="right" valign="middle">行政等级：</td>
      <td width="378" align="left" valign="middle">
      <input type="text" name="plevel" id="plevel" /></td>
    </tr>
    <tr>
