	...
	<div class="main">
		<div class="sideBar">
			...
			<ul class="nav nav-pills nav-stacked">
				...
				<li role="presentation">
					<a href="${pageContext.request.contextPath }/userlist">修改个人用户信息</a></li>
		...
		<div class="mainContainer">
			...
			<div class="funcContainer">
				...
				<span class="glyphicon glyphicon-th-list" aria-hidden="true" style="font-size: 48px"></span><br>修改个人信息</button>
			</div>
		</div>
	</div>
</body>
