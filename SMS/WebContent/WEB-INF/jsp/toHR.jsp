	...
	<div class="main">
		<div class="sideBar">
			...
			<ul class="nav nav-pills nav-stacked">
				...
				<li role="presentation">
					<a href="${pageContext.request.contextPath }/employeelist_hr">管理员工信息</a></li>
				<li role="presentation">
		...
		<div class="mainContainer">
			...
			<div class="funcContainer">
				...
				<button class="funcPaneButton" onclick="window.location.href='${pageContext.request.contextPath}/employeelist_hr'">
