...
<body>
	<center>学生信息</center>
	<form action="studentdelete" id="form1" name="form1" method="post">
			...
			<tr>
				...
				<c:forEach items="${studentList}" var="student">
					<tr>
						...
						<td>
							<a
							href="studentpreupdate?sno=${student.sno }&sname=${student.sname}
							&ssex=${student.ssex }&snative=${student.snative }&mno=${student.mno }">
							修改
							</a>
						</td>
						</tr>
